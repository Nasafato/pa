...
const encoderJsonFile = await readUrltoText(
  new URL("./encoder.json", import.meta.url)
);
const encoder = JSON.parse(encoderJsonFile);

const bpe_file = await readUrltoText(new URL("./vocab.bpe", import.meta.url));
